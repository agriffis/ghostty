...
pub const Handler = struct {
    ...
    pub const Effects = struct {
        ...
        /// reads) are never forwarded: answering one would let any program
        /// running in the terminal silently read the user's clipboard, and
        /// a VT state library has no way to mediate that with user consent.
